import { drawNeebs, drawAppsro } from './sprites/sprites.js';
...
export const CHARACTER_ROSTER = [
  ...
  { id: 'simon',   name: 'SIMON',   tagline: '',  color: '#44FF88', locked: true, desc: [], stats: {} },
  { id: 'dora',    name: 'DORA',    tagline: '',  color: '#FF44AA', locked: true, desc: [], stats: {} },
  { id: 'thick44', name: 'THICK44', tagline: '',  color: '#FFAA44', locked: true, desc: [], stats: {} },
];
